...
const EDITOR_TEXTS_BY_SECTION = {
  ...
  'AI Image Tab': [
    ...
    'Try these prompts',
    'Powered by Hugging Face · Stable Diffusion 3 Medium · Generation may take 10-30s',
  ],
  'Misc': [
...
const ADMIN_TEXTS_BY_SECTION = {
  ...
  'Settings': [
    'API Keys', 'Store Name', 'Unsplash Access Key', 'Hugging Face Token',
    'Get key at unsplash.com/developers',
  ...
  'Product Edit — Design': [
    ...
    'Print DPI (optional)',
    'Leave empty for automatic — 300 DPI, or lower only if the physical size requires it (e.g. desk mats, posters). Set a fixed value only if your print vendor requires an exact DPI; production fails loudly if that value does not fit the zone size, instead of being silently changed.',
